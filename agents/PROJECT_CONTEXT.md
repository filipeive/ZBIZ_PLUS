...
### 1. O que é o ZBIZ+? (Versão Atual 1.0.22)
...
* **ZBIZ POS 2.0 & Mobile PWA:** Frente de caixa rápida, suporte a leitor de código de barras, atalhos de teclado, compatibilidade nativa com subcaminhos de produção (`/zbiz_plus`), Progressive Web App com Service Worker e Bottom Navigation Bar inferior com acesso de polegar no smartphone.
* **ZBIZ Pharmacy & Catálogo Nacional ANARME:** Gestão farmacêutica com Lotes, Validades em 3 níveis (30/60/90 dias), saída FEFO, controlo de psicotrópicos e comando `php artisan zbiz:seed-pharma-catalog` para semear 60+ medicamentos essenciais de Moçambique com isenção do Artigo 9º do CIVA.
* **Cofre de Backup na Nuvem:** Criação e envio seguro de dumps SQL criptografados diretamente para o servidor central na nuvem (`/api/sync/backup-upload` ou `php artisan zbiz:backup-cloud-push`).
...
*Plataforma ZBIZ+ Enterprise Cloud & POS Suite — Versão 1.0.22*  
────────────────────────────────────────────────────────────────────────────  
