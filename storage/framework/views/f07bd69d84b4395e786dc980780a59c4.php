...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-2">
                    ...
                    <li class="nav-item ms-lg-4">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-glass btn-premium px-4">Entrar</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0 hero-canvas" data-aos="zoom-in" data-aos-delay="200">
                    <div class="image-wrapper">
                        ...
                        <img src="<?php echo e(asset('images/reprosys_hero_2025.png')); ?>" 
    ...
    <form id="demo-login-form" action="<?php echo e(route('demo.login')); ?>" method="POST" style="display:none;">
        <?php echo csrf_field(); ?>
    </form>
