...
<body class="bg-slate-950 text-slate-100 antialiased overflow-x-hidden" x-data="{ sector: 'retail', billingCycle: 'monthly' }">
    ...
    <nav class="relative z-20 max-w-7xl mx-auto px-6 py-5 flex items-center justify-between border-b border-slate-800/60 backdrop-blur-md">
        ...
        <div class="flex items-center space-x-3">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard.index')); ?>" class="bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-4 py-2 rounded-xl text-sm transition shadow-md shadow-emerald-600/30">
                    Aceder ao Painel <i class="fa-solid fa-arrow-right ml-1"></i>
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="text-slate-300 hover:text-white font-semibold text-sm px-3 py-2 transition">Entrar</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black px-5 py-2.5 rounded-xl text-sm transition shadow-lg shadow-emerald-500/25 hover:scale-105 active:scale-95">
    ...
    <header class="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 font-black px-8 py-4 rounded-2xl text-base shadow-xl shadow-emerald-500/25 hover:shadow-emerald-500/40 transition transform hover:-translate-y-0.5">
                <i class="fa-solid fa-rocket mr-2"></i> Criar Conta Grátis (30 Dias)
            </a>
            <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 border border-slate-700 text-white font-bold px-8 py-4 rounded-2xl text-base transition">
    ...
    <section id="precos" class="relative z-10 max-w-7xl mx-auto px-6 py-20 border-t border-slate-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between hover:border-slate-700 transition">
                ...
                <a href="<?php echo e(route('register', ['plan' => 'starter'])); ?>" class="mt-8 block text-center bg-slate-800 hover:bg-slate-700 text-white font-bold py-2.5 rounded-xl text-xs transition">
            ...
            <div class="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between hover:border-slate-700 transition">
                ...
                <a href="<?php echo e(route('register', ['plan' => 'pro'])); ?>" class="mt-8 block text-center bg-slate-800 hover:bg-slate-700 text-white font-bold py-2.5 rounded-xl text-xs transition">
                    Começar Grátis (30 Dias)
                </a>
            </div>
            ...
            <div class="bg-gradient-to-b from-slate-900 to-emerald-950/40 border-2 border-emerald-500/60 rounded-3xl p-6 flex flex-col justify-between shadow-xl shadow-emerald-500/10 relative">
                ...
                <a href="<?php echo e(route('register', ['plan' => 'pharmacy_plus', 'sector' => 'pharmacy'])); ?>" class="mt-8 block text-center bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black py-2.5 rounded-xl text-xs transition shadow-lg shadow-emerald-500/20">
                    Começar Grátis (30 Dias)
                </a>
            </div>
            ...
            <div class="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between hover:border-slate-700 transition">
                ...
                <a href="<?php echo e(route('register', ['plan' => 'business'])); ?>" class="mt-8 block text-center bg-slate-800 hover:bg-slate-700 text-white font-bold py-2.5 rounded-xl text-xs transition">
                    Começar Grátis (30 Dias)
                </a>
            </div>
    ...
    <footer class="relative z-10 border-t border-slate-900 bg-slate-950/80 py-10 px-6 text-center text-xs text-slate-500">
        <p>&copy; <?php echo e(date('Y')); ?> <strong>ZBIZ+</strong> — Plataforma Empresarial SaaS para Moçambique. Todos os direitos reservados.</p>
    </footer>

</body>
</html>
<?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/welcome.blade.php ENDPATH**/ ?>