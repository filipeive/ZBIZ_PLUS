...
<div class="max-w-3xl mx-auto space-y-6" x-data="{ hasBatch: <?php echo e($isPharmacy ? 'true' : 'false'); ?> }">
    ...
    <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
        <form action="<?php echo e(route('products.store')); ?>" method="POST" class="space-y-6">
            ...
            <div class="flex items-center justify-between border-b border-slate-800 pb-4">
                ...
                <?php if($isPharmacy): ?>
                    <span class="px-3 py-1 rounded-full text-xs font-bold border <?php echo e($theme['badge']); ?> flex items-center gap-1.5">
