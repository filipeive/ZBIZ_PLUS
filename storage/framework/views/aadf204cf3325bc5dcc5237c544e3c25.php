<div class="modal fade" id="createDebtModal" tabindex="-1" aria-labelledby="createDebtModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="create-debt-form" action="<?php echo e(route('debts.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="debt_date" id="debt_date" class="form-control" value="<?php echo e(now()->toDateString()); ?>" required>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="employee_id" id="employee_id" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($employee->id); ?>" data-name="<?php echo e($employee->name); ?>" data-phone="<?php echo e($employee->phone); ?>"><?php echo e($employee->name); ?></option>
...
</div><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/debts/partials/create_modal.blade.php ENDPATH**/ ?>