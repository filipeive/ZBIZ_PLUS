<?php $__env->startSection('title', 'Novo Pedido / Encomenda'); ?>
<?php $__env->startSection('page-title', 'Registo de Nova Encomenda'); ?>
...
<div class="space-y-6">
    ...
    <form id="order-form" action="<?php echo e(route('orders.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
                ...
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500" name="description" id="description" rows="3" required placeholder="Especificações técnicas, dimensões, materiais pretendidos..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500" name="notes" id="notes" rows="2" placeholder="Observações para a equipa..."><?php echo e(old('notes')); ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs" name="customer_name" id="customer_name" value="<?php echo e(old('customer_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs" name="customer_phone" id="customer_phone" value="<?php echo e(old('customer_phone')); ?>">
                    </div>
                    ...
                    <div>
                        ...
                        <select class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs" name="priority" id="priority" required>
                            <option value="low" <?php echo e(old('priority') == 'low' ? 'selected' : ''); ?>>Baixa</option>
                            <option value="medium" <?php echo e(old('priority', 'medium') == 'medium' ? 'selected' : ''); ?>>Média</option>
                            <option value="high" <?php echo e(old('priority') == 'high' ? 'selected' : ''); ?>>Alta</option>
                ...
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs font-mono font-bold" name="advance_payment" id="advance_payment" value="<?php echo e(old('advance_payment', 0)); ?>">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/orders/create.blade.php ENDPATH**/ ?>