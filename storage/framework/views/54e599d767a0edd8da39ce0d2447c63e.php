<?php $__env->startSection('title', 'Nova Venda'); ?>
<?php $__env->startSection('title-icon', 'fa-cash-register'); ?>
<?php $__env->startSection('page-title', 'Nova Venda'); ?>
...
<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('sales.index')); ?>"> <i class="fas fa-shopping-cart"></i> Vendas</a>
    </li>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        ...
                        <span class="badge bg-light text-primary ms-2" id="products-count"><?php echo e($products->count()); ?></span>
                    </h5>
                ...
                <div class="card-body p-2" style="max-height: 750px; overflow-y: auto;">
                    <div class="row g-3 products-container" id="products-container">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="col-sm-6 col-lg-4 product-item" data-name="<?php echo e(strtolower($product->name)); ?>"
                                data-type="<?php echo e($product->type); ?>" data-stock="<?php echo e($product->stock_quantity); ?>"
                                data-price="<?php echo e($product->selling_price); ?>">
                                <div class="card product-card <?php echo e($cardClass); ?>" data-product-id="<?php echo e($product->id); ?>">
                                    <div class="product-card-body">
                                        ...
                                        <div class="product-price">
                                            MZN <?php echo e(number_format($product->selling_price, 2, ',', '.')); ?>

                                        </div>

                                        <div class="product-stock-info <?php echo e($stockClass); ?>">
                                            <?php if($product->type === 'product'): ?>
                                                <?php if($isOutOfStock): ?>
                                        ...
                                        <button class="btn add-product-btn <?php echo e($isOutOfStock ? 'disabled' : ''); ?>"
                                            data-id="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>"
                                            data-price="<?php echo e($product->selling_price); ?>" data-type="<?php echo e($product->type); ?>"
                ...
                <div class="card-footer bg-light">
                    <div class="row text-center">
                        <div class="col-3">
                            ...
                            <strong id="stats-total"><?php echo e($products->count()); ?></strong>
                        </div>
                        <div class="col-3">
                            <small class="text-muted d-block">Produtos</small>
                            <strong id="stats-products"><?php echo e($products->where('type', 'product')->count()); ?></strong>
                        </div>
                        <div class="col-3">
                            <small class="text-muted d-block">Serviços</small>
                            <strong id="stats-services"><?php echo e($products->where('type', 'service')->count()); ?></strong>
                        </div>
                        <div class="col-3">
                            <small class="text-muted d-block">Stock Baixo</small>
                            <strong class="text-warning" id="stats-low-stock">
                                <?php echo e($products->where('type', 'product')->filter(function ($p) {return $p->stock_quantity <= ($p->min_stock_level ?? 5);})->count()); ?>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="orderCreationOffcanvas">
        ...
        <div class="offcanvas-body">
            <form id="order-form" action="<?php echo e(route('orders.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/sales/create.blade.php ENDPATH**/ ?>