    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8 space-y-8 transition-all duration-300 transform hover:shadow-xl">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                <?php echo e(__('Não tem problema. Informe seu e-mail que enviaremos um link para redefinir sua senha.')); ?>

            </p>
        </div>

        <!-- Formulário -->
        <form class="mt-6 space-y-6" method="POST" action="<?php echo e(route('password.email')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input
                        ...
                        required
                        autofocus
                        class="block w-full pl-10 pr-3 py-3 border <?php echo e($errors->has('email') ? 'border-red-500' : 'border-gray-300'); ?> rounded-md placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out text-sm"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium transition duration-150 ease-in-out">
                ← Voltar para o login
            </a>
        </div>
        ...
        <?php if(session('status')): ?>
            <div class="bg-green-50 border-l-4 border-green-400 p-4 mt-4">
                <div class="flex items-center">
                    ...
                    <p class="ml-2 text-sm text-green-700"><?php echo e(session('status')); ?></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>