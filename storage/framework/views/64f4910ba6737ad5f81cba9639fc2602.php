<?php $__env->startSection('title', 'Editar Dívida #' . $debt->id); ?>
<?php $__env->startSection('page-title', 'Editar Registo de Dívida'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-900/80 border border-slate-800 rounded-3xl p-5 shadow-xl backdrop-blur-xl">
        <div>
            <h2 class="text-lg font-black font-heading text-white flex items-center gap-2">
                ...
                Editar Dívida #<?php echo e($debt->id); ?>

            </h2>
            <p class="text-xs text-slate-400"><?php echo e($debt->debt_type_text); ?> - <?php echo e($debt->debtor_name); ?></p>
        </div>
    ...
    <!-- Formulário -->
    <form action="<?php echo e(route('debts.update', $debt)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
                ...
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl">
                    <div class="flex items-center space-x-3 border-b border-slate-800 pb-4 mb-4">
                        ...
                        <h3 class="text-sm font-black text-white font-heading">
                            <?php echo e($debt->isProductDebt() ? 'Informações do Cliente' : 'Informações do Funcionário'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="customer_name" value="<?php echo e(old('customer_name', $debt->customer_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="customer_phone" value="<?php echo e(old('customer_phone', $debt->customer_phone)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="customer_document" value="<?php echo e(old('customer_document', $debt->customer_document)); ?>">
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950/50 border border-slate-800/80 rounded-xl text-slate-400 text-xs cursor-not-allowed"
                                    value="<?php echo e($debt->employee->name ?? $debt->employee_name); ?>" disabled>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Nome Completo *</label>
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="employee_name" value="<?php echo e(old('employee_name', $debt->employee_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Telefone</label>
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="employee_phone" value="<?php echo e(old('employee_phone', $debt->employee_phone)); ?>">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Documento</label>
                                <input type="text" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                    name="employee_document" value="<?php echo e(old('employee_document', $debt->employee_document)); ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" class="w-full px-4 py-2.5 bg-slate-950/50 border border-slate-800/80 rounded-xl text-slate-400 text-xs cursor-not-allowed"
                                value="<?php echo e($debt->debt_date->format('Y-m-d')); ?>" disabled>
                        </div>
                        <div>
                            ...
                            <input type="date" class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                name="due_date" value="<?php echo e(old('due_date', $debt->due_date?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                name="description" rows="3" required><?php echo e(old('description', $debt->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs focus:ring-1 focus:ring-emerald-500 transition"
                                name="notes" rows="2"><?php echo e(old('notes', $debt->notes)); ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl space-y-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/30">
                                <?php echo e($debt->status_text); ?>

                            </span>
                        </div>
                        <div>
                            <span class="text-[10px] uppercase font-bold text-slate-500 block">Valor Original</span>
                            <div class="text-base font-bold font-mono text-white"><?php echo e($debt->formatted_original_amount); ?></div>
                        </div>
                        <div>
                            <span class="text-[10px] uppercase font-bold text-slate-500 block">Já Amortizado</span>
                            <div class="text-base font-bold font-mono text-emerald-400"><?php echo e($debt->formatted_amount_paid); ?></div>
                        </div>
                        <div>
                            <span class="text-[10px] uppercase font-bold text-slate-500 block">Saldo Restante</span>
                            <div class="text-xl font-black font-mono text-rose-400"><?php echo e($debt->formatted_remaining_amount); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-slate-800 space-y-2">
                        ...
                        <a href="<?php echo e(route('debts.show', $debt)); ?>" class="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs flex items-center justify-center gap-2 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/debts/edit.blade.php ENDPATH**/ ?>