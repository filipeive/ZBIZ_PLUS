<?php $__env->startSection('title', 'Modelos e Templates de Documentos'); ?>
<?php $__env->startSection('page-title', 'Modelos de Documentos'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-900/80 border border-slate-800 rounded-3xl p-5 shadow-xl backdrop-blur-xl">
        ...
        <a href="<?php echo e(route('documents.templates.rent-contract.print')); ?>" target="_blank" class="px-4 py-2.5 rounded-2xl bg-gradient-to-r <?php echo e($theme['gradient']); ?> text-slate-950 font-black text-xs shadow-lg shadow-emerald-500/20 hover:scale-105 active:scale-95 transition flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between hover:border-slate-700 transition group">
            ...
            <div class="pt-4 border-t border-slate-800 flex justify-end">
                <a href="<?php echo e(route('documents.templates.rent-contract.print')); ?>" target="_blank" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5">
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between hover:border-slate-700 transition group">
            ...
            <div class="pt-4 border-t border-slate-800 flex justify-end">
                <a href="<?php echo e(route('expenses.index')); ?>" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5">
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl flex flex-col justify-between hover:border-slate-700 transition group">
            ...
            <div class="pt-4 border-t border-slate-800 flex justify-end">
                <a href="<?php echo e(route('users.employees.payroll')); ?>" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/documents/templates/index.blade.php ENDPATH**/ ?>