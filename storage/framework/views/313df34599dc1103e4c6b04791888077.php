...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-900/80 border border-slate-800 rounded-3xl p-5 shadow-xl backdrop-blur-xl">
        ...
        <div class="flex flex-wrap items-center gap-2.5">
            ...
            <button type="button" onclick="window.print()" class="px-4 py-2 <?php echo e($theme['btn']); ?> text-xs rounded-xl hover:scale-105 active:scale-95 transition flex items-center gap-2">
    ...
    <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl">
        ...
        <form method="GET" action="<?php echo e(route('reports.sales-specialized')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            <div>
                ...
                <select name="tenant_id" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white focus:ring-2 <?php echo e($theme['ring']); ?> outline-none">
            ...
            <div>
                ...
                <input type="text" name="product_search" value="<?php echo e($productSearch ?? ''); ?>" placeholder="Ex: Paracetamol, Amoxicilina..."
            ...
            <div class="sm:col-span-2 lg:col-span-6 flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-slate-800">
                ...
                <div class="flex flex-wrap items-center gap-1.5 text-xs">
                    ...
                    <a href="<?php echo e(route('reports.sales-specialized', array_merge(request()->all(), ['date_from' => now()->toDateString(), 'date_to' => now()->toDateString()]))); ?>"
                    ...
                    <a href="<?php echo e(route('reports.sales-specialized', array_merge(request()->all(), ['date_from' => now()->startOfWeek()->toDateString(), 'date_to' => now()->endOfWeek()->toDateString()]))); ?>"
                    ...
                    <a href="<?php echo e(route('reports.sales-specialized', array_merge(request()->all(), ['date_from' => now()->startOfMonth()->toDateString(), 'date_to' => now()->endOfMonth()->toDateString()]))); ?>"
                    ...
                    <a href="<?php echo e(route('reports.sales-specialized', array_merge(request()->all(), ['date_from' => now()->subMonth()->startOfMonth()->toDateString(), 'date_to' => now()->subMonth()->endOfMonth()->toDateString()]))); ?>"
                ...
                <div class="flex items-center gap-2">
                    <button type="submit" class="px-5 py-2 <?php echo e($theme['btn']); ?> text-xs rounded-xl transition flex items-center gap-2">
                        <i class="fa-solid fa-filter"></i> Aplicar Filtros
                    </button>
                    <?php if(request()->hasAny(['date_from', 'date_to', 'payment_method', 'product_search', 'customer_id', 'tenant_id'])): ?>
                        <a href="<?php echo e(route('reports.sales-specialized')); ?>" class="px-3.5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white rounded-xl text-xs font-bold transition">
                            Limpar
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4 pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <span class="text-xs font-bold px-3 py-1 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 rounded-xl border border-emerald-200 dark:border-emerald-500/30">
                Total: <?php echo e(count($allProductSales ?? [])); ?> Artigos Vendidos
            </span>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60 font-mono">
                    <?php $__empty_1 = true; $__currentLoopData = $allProductSales ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition">
                            <td class="py-3 font-sans font-bold text-slate-900 dark:text-white">
                                <i class="fa-solid fa-pills mr-1.5 text-emerald-500"></i><?php echo e($item['name']); ?>
                            ...
                            <td class="py-3 text-center">
                                <span class="px-3 py-1 rounded-xl font-bold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30">
                                    <?php echo e(number_format($item['quantity'], 0)); ?> un
                                </span>
                            </td>
                            ...
                            <td class="py-3 text-right text-slate-900 dark:text-white font-bold">
                                <?php echo e(number_format($item['revenue'], 2, ',', '.')); ?> MT
                            </td>
                            <td class="py-3 text-right <?php echo e($item['profit'] >= 0 ? 'text-teal-600 dark:text-teal-400 font-bold' : 'text-rose-600 dark:text-rose-400 font-bold'); ?>">
                                <?php echo e(number_format($item['profit'], 2, ',', '.')); ?> MT
                            </td>
                            <td class="py-3 text-center font-sans font-bold">
                                <span class="px-2 py-0.5 rounded text-[10px] <?php echo e($item['margin'] >= 20 ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-amber-50 text-amber-700 border border-amber-200'); ?>">
                                    <?php echo e(number_format($item['margin'], 1, ',', '.')); ?>%
                                </span>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <tr class="hover:bg-slate-800/30 transition">
                            ...
                            <td class="py-3 text-center font-mono">
                                ...
                                <div class="w-24 bg-slate-800 h-1.5 rounded-full mx-auto mt-1 overflow-hidden">
                                    <div class="bg-emerald-500 h-full" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                            </td>
