...
<body class="bg-slate-950 text-slate-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center bg-slate-900/90 border border-slate-800 rounded-3xl p-8 shadow-2xl backdrop-blur-xl space-y-6">
        ...
        <div class="pt-2 flex flex-col gap-2">
            <a href="<?php echo e(route('login')); ?>" class="w-full py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md hover:scale-105 active:scale-95 transition flex items-center justify-center">
...
<?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/errors/419.blade.php ENDPATH**/ ?>