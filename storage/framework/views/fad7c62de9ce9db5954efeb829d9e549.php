<div class="modal fade" id="markAsPaidModal" tabindex="-1" aria-labelledby="markAsPaidModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-slate-900 border border-slate-800 text-white rounded-3xl p-2 shadow-2xl">
            ...
            <form action="<?php echo e(route('debts.mark-as-paid', $debt)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>
                <div class="modal-body space-y-4 py-4 text-xs text-slate-300">
                    <p>Você está prestes a liquidar a dívida <strong class="text-white">#<?php echo e($debt->id); ?></strong> de <strong class="text-white"><?php echo e($debt->debtor_name); ?></strong> como totalmente paga.</p>
                    <p>O saldo restante de <strong class="text-rose-400 font-mono font-bold">MT <?php echo e(number_format($debt->remaining_amount, 2, ',', '.')); ?></strong> será amortizado por completo.</p>
                    ...
                    <div>
                        ...
                        <input type="date" name="payment_date" id="paid_payment_date" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs" value="<?php echo e(now()->toDateString()); ?>" max="<?php echo e(now()->toDateString()); ?>" required>
                    </div>
...
<?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/debts/partials/mark_as_paid_modal.blade.php ENDPATH**/ ?>