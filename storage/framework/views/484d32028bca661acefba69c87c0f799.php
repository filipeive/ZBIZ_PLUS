...
<head>
    ...
    <style>
        :root {
            --tenant-primary: <?php echo e($theme['hex']); ?>;
                ...
                <nav class="p-4 space-y-5 text-xs font-medium">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('license.activate')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('license.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                                <i class="fa-solid fa-key w-4 text-center <?php echo e(request()->routeIs('license.*') ? $theme['text_accent'] : ''); ?>"></i>
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="<?php echo e(route('users.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('users.index') || request()->routeIs('users.show') || request()->routeIs('users.edit') || request()->routeIs('users.create') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                                <i class="fa-solid fa-users-gear w-4 text-center <?php echo e(request()->routeIs('users.*') ? $theme['text_accent'] : ''); ?>"></i>
                                <span>Todos os Utilizadores</span>
                            </a>
                            <a href="<?php echo e(route('users.activity')); ?>"
                            ...
                            <a href="<?php echo e(route('admin.settings')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('admin.settings*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                                <i class="fa-solid fa-sliders w-4 text-center <?php echo e(request()->routeIs('admin.settings*') ? $theme['text_accent'] : ''); ?>"></i>
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="<?php echo e(route('dashboard.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('dashboard*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="<?php echo e(route('sales.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('sales.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                            ...
                            <a href="<?php echo e(route('orders.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('orders.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('categories.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('categories.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                            ...
                            <a href="<?php echo e(route('stock-movements.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('stock-movements.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('expenses.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('expenses.*') || request()->routeIs('expense-categories.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                                <i class="fa-solid fa-money-bill-transfer w-4 text-center <?php echo e(request()->routeIs('expenses.*') || request()->routeIs('expense-categories.*') ? $theme['text_accent'] : ''); ?>"></i>
                    ...
                    <?php if(auth()->user()->isAdmin() || auth()->user()->isSuperAdmin() || auth()->user()->isManager()): ?>
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('document-templates.index')); ?>"
                               class="flex items-center space-x-3 px-3 py-2 rounded-xl transition <?php echo e(request()->routeIs('document-templates.*') ? 'bg-slate-800 text-white font-bold border-l-2 ' . $theme['border'] : 'text-slate-400 hover:bg-slate-800/60 hover:text-slate-200'); ?>">
                                <i class="fa-solid fa-file-invoice w-4 text-center <?php echo e(request()->routeIs('document-templates.*') ? $theme['text_accent'] : ''); ?>"></i>
