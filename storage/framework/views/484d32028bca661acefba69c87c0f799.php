...
<body>
    ...
    <nav class="app-sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <?php if(userCanAny(['view_products', 'manage_categories', 'view_stock_movements'])): ?>
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="<?php echo e(route('products.index')); ?>"
                                ...
                                <?php elseif(userCan('edit_products')): ?>
                        ...
                        <?php if(userCan('manage_categories')): ?>
                            <li class="nav-item">
                        ...
                        <?php if(userCan('view_stock_movements')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('stock-movements.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('stock-movements.*') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                        <i class="fas fa-boxes"></i>
                                    </span>
                                    <span class="nav-text">Controle de Estoque</span>
                                    <?php if(userCan('create_stock_movements')): ?>
            ...
            <?php if(userCanAny(['view_sales', 'view_orders', 'create_orders', 'create_sales'])): ?>
                <div class="nav-section">
                        ...
                        <?php if(userCanAny(['view_orders', 'create_orders'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('orders.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('orders.*') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                    ...
                                    <?php if($pendingOrders > 0): ?>
                                        <span class="nav-badge badge-danger"><?php echo e($pendingOrders); ?></span>
                                    <?php endif; ?>
                                    <?php if(userCan('create_orders')): ?>
                        ...
                        <?php if(userCan('view_sales')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('sales.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('sales.*') && !request()->routeIs('sales.create') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                        <i class="fas fa-shopping-cart"></i>
                                    </span>
                                    <span class="nav-text">Histórico de Vendas</span>
                                    <?php if(userCan('edit_sales')): ?>
                                        <span class="nav-badge badge-success">Completo</span>
                                    <?php elseif(userCan('edit_own_sales')): ?>
            ...
            <?php if(userCanAny(['manage_debts', 'view_expenses', 'view_reports', 'view_finances'])): ?>
                <div class="nav-section">
                    <div class="nav-section-title">Gestão Financeira</div>
                    <ul class="nav-list">
                        <?php if(userCanAny(['manage_debts', 'view_debts'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('debts.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('debts.*') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                    ...
                                    <?php if($overdueDebts > 0): ?>
                                        <span class="nav-badge badge-danger"><?php echo e($overdueDebts); ?></span>
                                    <?php endif; ?>
                                    <?php if(userCan('create_debts')): ?>
                                        <span class="nav-badge badge-primary">Criar</span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        ...
                        <?php if(userCan('view_expenses')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('expenses.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('expenses.*') && !request()->routeIs('expenses.operational') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                        <i class="fas fa-receipt"></i>
                                    </span>
                                    <span class="nav-text">Despesas</span>
                                    <?php if(userCan('edit_expenses')): ?>
                                        <span class="nav-badge badge-primary">Editar</span>
                                    <?php elseif(userCan('create_expenses')): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('expenses.operational')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('expenses.operational') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                        ...
                        <?php if(userCan('view_finances')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('finances.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('finances.*') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                                        <i class="fas fa-wallet"></i>
                                    </span>
                                    <span class="nav-text">Finanças</span>
                                    <?php if(userCan('manage_finances')): ?>
                                        <span class="nav-badge badge-primary">Gerir</span>
                                    <?php else: ?>
                                        <span class="nav-badge badge-secondary">Ver</span>
                                    <?php endif; ?>
                        ...
                        <?php if(userCanAny(['view_reports', 'export_reports'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('reports.index')); ?>"
                                    ...
                                    <?php if(userCan('export_reports')): ?>
                                        <span class="nav-badge badge-success">Export</span>
                                    <?php elseif(userCan('view_reports')): ?>
                                        <span class="nav-badge badge-primary">Avançado</span>
                                    <?php elseif(userCan('view_basic_reports')): ?>
            ...
            <?php if(userCanAny(['manage_users', 'manage_settings', 'backup_system', 'view_logs'])): ?>
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        <?php if(userCan('manage_users')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('users.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('users.index') || request()->routeIs('users.create') || request()->routeIs('users.edit') || request()->routeIs('users.activity') || request()->routeIs('users.temporary-passwords') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('users.employees')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('users.employees') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
                        ...
                        <?php if(userCan('manage_settings')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('documents.templates.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('documents.templates.*') ? 'active' : ''); ?>">
                                    <span class="nav-icon">
        ...
        <div class="user-area">
            <div class="user-profile">
                ...
                <div class="user-info">
                    <div class="user-name"><?php echo e(explode(' ', auth()->user()->name)[0]); ?></div>
                    <div class="user-role">
    ...
    <div class="app-content" id="main-content">
        ...
        <header class="app-header">
            <div class="header-left">
                ...
                <h1 class="page-title">
                    <i class="<?php echo e($titleIcon ?? 'fas fa-tachometer-alt'); ?>"></i>
            ...
            <div class="header-right">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg" style="width: 380px;" id="notification-list">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li>
                            <a class="dropdown-item d-flex align-items-start py-3 <?php echo e($notification->read ? '' : 'bg-light'); ?>"
                                href="<?php echo e($notification->action_url ?? '#'); ?>"
                                onclick="markAsRead(<?php echo e($notification->id); ?>, event)">
                                <div class="flex-shrink-0 me-3">
                                    <i
                                        class="<?php echo e($notification->icon ?? 'fas fa-bell'); ?> text-<?php echo e($notification->type === 'success' ? 'success' : ($notification->type === 'error' ? 'danger' : ($notification->type === 'warning' ? 'warning' : 'info'))); ?>"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="fw-semibold mb-1"><?php echo e($notification->title); ?></div>
                                    <div class="text-muted small mb-1"><?php echo e($notification->message); ?></div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('sales.create')); ?>">
        ...
        <div class="content-area">
            ...
            <?php if(session('error')): ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    <strong>Erro!</strong> <?php echo e(session('error')); ?>
            ...
            <?php if(session('info')): ?>
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <strong>Informação!</strong> <?php echo e(session('info')); ?>
        ...
        <!-- Professional Footer -->
        <footer class="footer">
            <div class="container-fluid" style="padding: 0 <?php echo e(auth()->check() ? '20px' : '20px'); ?>;">
                <?php if(request()->routeIs('dashboard.index')): ?>
                    <div class="footer-content">
                        ...
                        <div class="footer-section">
                            ...
                            <ul>
                                <?php if(userCan('view_dashboard')): ?>
                                <li><a href="<?php echo e(route('dashboard.index')); ?>"><i class="fas fa-chart-line"></i> Dashboard</a></li>
                                <?php endif; ?>
                                <?php if(userCan('view_sales')): ?>
                                <li><a href="<?php echo e(route('sales.index')); ?>"><i class="fas fa-receipt"></i> Vendas</a></li>
                                <?php endif; ?>
                                <?php if(userCan('view_products')): ?>
                                <li><a href="<?php echo e(route('products.index')); ?>"><i class="fas fa-cube"></i> Produtos</a></li>
                                <?php endif; ?>
                                <?php if(userCan('view_reports')): ?>
                                <li><a href="<?php echo e(route('reports.index')); ?>"><i class="fas fa-chart-bar"></i> Relatórios</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-status">
                        <span class="badge bg-info">© <?php echo e(date('Y')); ?> FDSMULTSERVICES+</span>
                        <span id="server-date"><?php echo e(now()->format('d/m/Y')); ?></span>
                        
                        <span class="text-muted">|</span>
                        <span id="server-time"><?php echo e(now()->format('H:i:s')); ?></span>
                    </div>
    ...
    <script>
        ...
        async function showSettings() {
            try {
                const getSettingsUrl = "<?php echo e(route('admin.settings.get')); ?>";
        ...
        async function saveSettings() {
            try {
                const saveSettingsUrl = "<?php echo e(route('admin.settings.save')); ?>";
                const data = {
        ...
        async function triggerBackup() {
            try {
                ...
                const response = await fetch("<?php echo e(url('/admin/backup')); ?>", {
                    method: 'POST',
                    headers: {
        ...
        async function viewLogs() {
            try {
                const response = await fetch("<?php echo e(url('/admin/logs')); ?>");
                const data = await response.json();
                if (data.success) {
        ...
        async function clearLogs() {
            ...
            try {
                const response = await fetch("<?php echo e(url('/admin/logs/clear')); ?>", {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>",
                        'Accept': 'application/json'
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function() {
                    ...
                    searchTimeout = setTimeout(() => {
                        fetch(`<?php echo e(route('search.api')); ?>?q=${encodeURIComponent(query)}&limit=5`, {
                            headers: {
                                'Accept': 'application/json',
                                'X-Requested-With': 'XMLHttpRequest'
                            }
                        ...
                        .then(data => {
                            if (data.results && Object.keys(data.results).length > 0) {
                                ...
                                html += `<a href="<?php echo e(route('search.index')); ?>?q=${encodeURIComponent(query)}" class="global-search-link">
