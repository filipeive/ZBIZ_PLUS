<?php $__env->startSection('title', 'Vendas por Produto'); ?>
<?php $__env->startSection('page-title', 'Vendas por Produto'); ?>
<?php $__env->startSection('title-icon', 'fa-box'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4 fade-in">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('reports.sales-by-product')); ?>" id="filters-form">
                <div class="row g-3">
                    <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-primary fw-bold"><?php echo e($sales->count()); ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-success fw-bold"><?php echo e(number_format($sales->sum('quantity_sold'))); ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-warning fw-bold"><?php echo e(number_format($sales->sum('total_revenue'), 2, ',', '.')); ?> MT</h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-danger fw-bold"><?php echo e(number_format($sales->avg('total_revenue'), 2, ',', '.')); ?> MT</h3>
    ...
    <div class="card fade-in">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary">Total: <?php echo e($sales->count()); ?></span>
            </div>
        </div>
                ...
                <table class="table table-hover align-middle mb-0" id="products-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><strong><?php echo e($sale->name); ?></strong></td>
                                <td class="text-center">
                                    <span class="badge bg-light text-dark"><?php echo e(number_format($sale->quantity_sold)); ?></span>
                                </td>
                                <td class="text-end text-success fw-bold">
                                    <?php echo e(number_format($sale->total_revenue, 2, ',', '.')); ?> MT
                                </td>
                                <td class="text-end">
                                    <?php echo e(number_format($sale->total_revenue / $sale->quantity_sold, 2, ',', '.')); ?> MT
                                </td>
                                <td class="text-center">
                                    <span class="badge bg-info">
                                        <?php echo e(number_format(($sale->total_revenue / $sales->sum('total_revenue')) * 100, 1)); ?>%
                                    </span>
                                </td>
                            </tr>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        function exportReport() {
            ...
            window.open('<?php echo e(route("reports.export")); ?>?' + params.toString(), '_blank');
        }

        document.addEventListener('DOMContentLoaded', function () {
            // Dados do gráfico
            const topProducts = <?php echo json_encode($sales->take(10)->pluck('name'), 15, 512) ?>;
            const topProductsData = <?php echo json_encode($sales->take(10)->pluck('total_revenue'), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/reports/sales_by_product.blade.php ENDPATH**/ ?>