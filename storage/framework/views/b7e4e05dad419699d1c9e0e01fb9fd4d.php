...
<?php $__env->startSection('page-title', 'Meu Perfil & Configurações da Conta'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl text-center">
                ...
                <h3 class="text-lg font-black font-heading text-white"><?php echo e($user->name); ?></h3>
                <p class="text-xs text-slate-400 mb-3"><?php echo e($user->email); ?></p>

                <div class="mb-5">
                    <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider <?php echo e($user->is_admin ? 'bg-rose-500/10 text-rose-400 border border-rose-500/30' : 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'); ?>">
                        <?php echo e($user->role_display ?? 'Utilizador'); ?>
                ...
                <div class="space-y-2 mb-6">
                    <button type="button" 
                        ...
                        <i class="fa-solid fa-camera <?php echo e($theme['text_accent']); ?>"></i>
                ...
                <div class="border-t border-slate-800/80 pt-4 text-left space-y-2 text-xs text-slate-400">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-slate-300"><?php echo e($user->created_at ? $user->created_at->format('d/m/Y') : '-'); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="flex items-center gap-2"><i class="fa-solid fa-clock text-slate-500"></i> Último acesso</span>
                        <span class="font-semibold text-slate-300"><?php echo e($user->last_login_display ?? 'Nunca'); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="flex items-center gap-2"><i class="fa-solid fa-id-badge text-slate-500"></i> Identificador</span>
                        <span class="font-mono text-slate-300">#<?php echo e($user->id); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(auth()->user()->is_admin && isset($roles)): ?>
                            <div>
                        ...
                        <?php else: ?>
                            <div>
                                ...
                                <input type="text" 
                                       value="<?php echo e($user->role_display); ?>" 
                                       disabled
                    ...
                    <div class="pt-4 flex items-center justify-end gap-3 border-t border-slate-800">
                        <button type="submit" 
                                class="px-5 py-2.5 rounded-2xl bg-gradient-to-r <?php echo e($theme['gradient']); ?> text-slate-950 font-black text-xs shadow-lg shadow-emerald-500/20 hover:scale-105 active:scale-95 transition flex items-center gap-2">
        ...
        <div @click.away="showPhotoModal = false" class="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4">
            <div class="flex items-center justify-between border-b border-slate-800 pb-3">
                <h3 class="text-sm font-black text-white flex items-center gap-2">
                    <i class="fa-solid fa-camera <?php echo e($theme['text_accent']); ?>"></i> Alterar Foto de Perfil
                </h3>
                <button @click="showPhotoModal = false" class="text-slate-400 hover:text-white"><i class="fa-solid fa-xmark"></i></button>
            </div>

            <form method="POST" action="<?php echo e(route('profile.update-photo')); ?>" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('patch'); ?>
                ...
                <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-800">
                    ...
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r <?php echo e($theme['gradient']); ?> text-slate-950 rounded-xl text-xs font-black">Submeter Foto</button>
                </div>
            </form>
        </div>
    </div>
