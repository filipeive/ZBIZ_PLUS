<?php $__env->startSection('title', 'Demonstração de Resultados (DRE)'); ?>
<?php $__env->startSection('page-title', 'Demonstração de Resultados do Exercício (DRE)'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-lg backdrop-blur-xl">
            ...
            <div class="text-2xl font-black font-heading text-white font-mono mt-2"><?php echo e(number_format($salesRevenue, 2, ',', '.')); ?> MT</div>
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-lg backdrop-blur-xl">
            ...
            <div class="text-2xl font-black font-heading text-amber-400 font-mono mt-2">(<?php echo e(number_format($costOfGoodsSold, 2, ',', '.')); ?>) MT</div>
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-lg backdrop-blur-xl">
            ...
            <div class="text-2xl font-black font-heading <?php echo e($grossProfit >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?> font-mono mt-2">
                <?php echo e(number_format($grossProfit, 2, ',', '.')); ?> MT
            </div>
            <div class="text-xs text-emerald-400/80 mt-1 font-semibold">Margem Bruta: <?php echo e(number_format($grossMargin, 1)); ?>%</div>
        </div>

        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-lg backdrop-blur-xl">
            <span class="text-xs font-bold uppercase tracking-wider text-slate-400">Lucro Operacional</span>
            <div class="text-2xl font-black font-heading <?php echo e($operatingProfit >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?> font-mono mt-2">
                <?php echo e(number_format($operatingProfit, 2, ',', '.')); ?> MT
            </div>
            <div class="text-xs <?php echo e($operatingProfit >= 0 ? 'text-emerald-400/80' : 'text-rose-400/80'); ?> mt-1 font-semibold">
                Margem Líquida: <?php echo e(number_format($operatingMargin, 1)); ?>%
            </div>
        </div>
    </div>
    ...
    <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl backdrop-blur-xl">
        <div class="border-b border-slate-800 pb-4 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
                ...
                <p class="text-xs text-slate-400">Competência: <?php echo e(\Carbon\Carbon::parse($dateFrom)->format('d/m/Y')); ?> até <?php echo e(\Carbon\Carbon::parse($dateTo)->format('d/m/Y')); ?></p>
            </div>
        </div>
        ...
        <div class="space-y-4 text-xs font-medium">
            ...
            <div class="p-4 rounded-2xl bg-slate-950 border border-slate-800/80 flex items-center justify-between">
                ...
                <span class="text-sm font-black font-mono text-emerald-400"><?php echo e(number_format($salesRevenue, 2, ',', '.')); ?> MT</span>
            </div>
            ...
            <div class="p-4 rounded-2xl bg-slate-950 border border-slate-800/80 flex items-center justify-between">
                ...
                <span class="text-sm font-bold font-mono text-amber-400">(<?php echo e(number_format($costOfGoodsSold, 2, ',', '.')); ?>) MT</span>
            </div>
            ...
            <div class="p-4 rounded-2xl bg-slate-800/50 border border-slate-700/60 flex items-center justify-between">
                ...
                <span class="text-base font-black font-mono <?php echo e($grossProfit >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?>">
                    <?php echo e(number_format($grossProfit, 2, ',', '.')); ?> MT
                </span>
            </div>
            ...
            <div class="p-4 rounded-2xl bg-slate-950 border border-slate-800/80 flex items-center justify-between">
                ...
                <span class="text-sm font-bold font-mono text-rose-400">(<?php echo e(number_format($totalOperatingExpenses, 2, ',', '.')); ?>) MT</span>
            </div>
            ...
            <div class="p-5 rounded-2xl bg-slate-900 border-2 <?php echo e($operatingProfit >= 0 ? 'border-emerald-500/50' : 'border-rose-500/50'); ?> flex items-center justify-between">
                ...
                <span class="text-xl sm:text-2xl font-black font-mono <?php echo e($operatingProfit >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?>">
                    <?php echo e(number_format($operatingProfit, 2, ',', '.')); ?> MT
                </span>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const revenue = <?php echo e($salesRevenue); ?>;
    const cogs = <?php echo e($costOfGoodsSold); ?>;
    const expenses = <?php echo e($totalOperatingExpenses); ?>;
    const profit = <?php echo e($operatingProfit); ?>;
    ...
    if (dreCtx) {
        new Chart(dreCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Montante (MT)',
                    data: [revenue, cogs, <?php echo e($grossProfit); ?>, expenses, profit],
                    backgroundColor: [
                        'rgba(14, 165, 233, 0.8)',
                        'rgba(245, 158, 11, 0.8)',
                        'rgba(20, 184, 166, 0.8)',
