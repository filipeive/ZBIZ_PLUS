<div class="modal fade" id="addPaymentModal" tabindex="-1" aria-labelledby="addPaymentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-slate-900 border border-slate-800 text-white rounded-3xl p-2 shadow-2xl">
            ...
            <form action="<?php echo e(route('debts.add-payment', $debt)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body space-y-4 py-4">
                    <p class="text-xs text-slate-300">Dívida: <strong class="text-white">#<?php echo e($debt->id); ?></strong></p>
                    <p class="text-xs text-slate-300">Valor Pendente: <strong class="text-rose-400 font-mono">MT <?php echo e(number_format($debt->remaining_amount, 2, ',', '.')); ?></strong></p>
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" id="payment_amount" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs font-mono font-bold" step="0.01" min="0.01" max="<?php echo e($debt->remaining_amount); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="payment_date" id="payment_date" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-white text-xs" value="<?php echo e(now()->toDateString()); ?>" max="<?php echo e(now()->toDateString()); ?>" required>
                    </div>
                ...
                <div class="modal-footer border-t border-slate-800 pt-3 flex justify-end gap-2">
                    ...
                    <button type="submit" class="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md">Salvar Pagamento</button>
                </div>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/debts/partials/add_payment_modal.blade.php ENDPATH**/ ?>