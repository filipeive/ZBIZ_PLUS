<?php $__env->startSection('title', 'Relatórios Fiscais & Analítica'); ?>
<?php $__env->startSection('page-title', 'Centro de Relatórios & Inteligência Comercial'); ?>
...
<div class="space-y-6" x-data="{ reportPeriod: 'month' }">
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <?php if(current_branch()): ?>
                    <span class="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30">
                        <i class="fa-solid fa-store mr-1"></i> <?php echo e(current_branch()->name); ?>
        ...
        <div class="flex flex-wrap items-center gap-3">
            <?php if(auth()->user()?->isSuperAdmin()): ?>
                <form method="GET" action="<?php echo e(url()->current()); ?>" class="flex items-center gap-2">
                    ...
                    <select name="tenant_id" onchange="this.form.submit()" class="text-xs font-bold bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-slate-800 dark:text-slate-200">
                        <option value="all" <?php echo e(request('tenant_id') === 'all' || !request('tenant_id') ? 'selected' : ''); ?>>Todos os Tenants (Global)</option>
            ...
            <a href="<?php echo e(route('reports.cash-flow')); ?>" class="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-bold text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 transition">
                <i class="fa-solid fa-money-bill-wave text-emerald-600 dark:text-emerald-400 mr-1.5"></i> Fluxo de Caixa
            </a>
            <a href="<?php echo e(route('reports.profit-loss')); ?>" class="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-bold text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('reports.sales-specialized')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.cash-flow')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.profit-loss')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.abc-analysis')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.expenses-specialized')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.business-insights')); ?>" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.low-stock')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
