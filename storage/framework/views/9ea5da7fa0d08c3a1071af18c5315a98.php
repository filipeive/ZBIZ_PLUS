...
<div class="space-y-6" x-data="{ reportPeriod: 'month' }">
    ...
    <div class="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('reports.cash-flow')); ?>" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-xs font-bold text-white rounded-xl border border-slate-700 transition">
                <i class="fa-solid fa-money-bill-wave <?php echo e($theme['text_accent']); ?> mr-1.5"></i> Fluxo de Caixa
            </a>
            <a href="<?php echo e(route('reports.profit-loss')); ?>" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-xs font-bold text-white rounded-xl border border-slate-700 transition">
                <i class="fa-solid fa-scale-balanced <?php echo e($theme['text_accent']); ?> mr-1.5"></i> DRE / Lucros
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('reports.sales-specialized')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.cash-flow')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.profit-loss')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.abc-analysis')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
        ...
        <a href="<?php echo e(route('reports.expenses-specialized')); ?>" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-lg backdrop-blur-xl hover:border-slate-700 transition group flex flex-col justify-between">
            <div>
