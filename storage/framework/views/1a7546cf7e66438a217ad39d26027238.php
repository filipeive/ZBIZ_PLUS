<?php $__env->startSection('title', 'Vendas Mensais'); ?>
<?php $__env->startSection('page-title', 'Relatório de Vendas Mensais'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-lg backdrop-blur-xl">
            ...
            <div class="text-2xl font-black font-heading text-white mt-2"><?php echo e($sales->count()); ?> <span class="text-xs font-normal text-slate-400">meses</span></div>
    ...
    <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl overflow-hidden">
        <div class="flex items-center justify-between pb-4 border-b border-slate-800 mb-4">
            <div>
                <h3 class="text-base font-black font-heading text-white">Histórico Mensal de Faturamento (<?php echo e($sales->count()); ?>)</h3>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-800/30 transition">
                            <td class="py-3.5 font-bold text-white">
                                ...
                                <?php echo e(ucfirst(\Carbon\Carbon::createFromFormat('Y-m', $sale->month ?? date('Y-m'))->locale('pt_BR')->translatedFormat('F / Y'))); ?>
                            ...
                            <td class="py-3.5 text-right">
                                <a href="<?php echo e(route('sales.index')); ?>" class="inline-flex items-center px-3 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-bold transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/reports/monthly_sales.blade.php ENDPATH**/ ?>