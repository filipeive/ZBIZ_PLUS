<?php $__env->startSection('title', 'Solicitar redefinição de senha'); ?>
<?php $__env->startSection('subtitle', 'Receba o link de acesso para a conta'); ?>
...
<form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-5">
    ...
    <?php if(session('status')): ?>
        <div class="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-400" role="status" aria-live="polite">
            <i class="fa-solid fa-circle-check mr-2"></i><?php echo e(session('status')); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="pt-2 text-center">
        <a href="<?php echo e(route('login')); ?>" class="text-xs font-bold text-emerald-400 hover:underline">Voltar para o login</a>
    </div>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>