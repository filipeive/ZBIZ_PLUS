<?php $__env->startSection('title', 'Movimentos de Estoque'); ?>
<?php $__env->startSection('page-title', 'Movimentos de Estoque'); ?>
<?php
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card stats-card h-100" style="border-top: 4px solid var(--primary-blue) !important;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="stats-value"><?php echo e(number_format($movements->total())); ?></div>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6">
            <div class="card stats-card h-100" style="border-top: 4px solid var(--success-green) !important;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="stats-value"><?php echo e($movements->where('movement_type', 'in')->count()); ?></div>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6">
            <div class="card stats-card h-100" style="border-top: 4px solid var(--danger-red) !important;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="stats-value"><?php echo e($movements->where('movement_type', 'out')->count()); ?></div>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6">
            <div class="card stats-card h-100" style="border-top: 4px solid var(--warning-orange) !important;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="stats-value"><?php echo e($movements->where('movement_type', 'adjustment')->count()); ?></div>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6">
            <div class="card stats-card h-100" style="border-top: 4px solid var(--info-blue) !important;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="stats-value"><?php echo e($movements->where('movement_date', '>=', now()->startOfDay())->count()); ?></div>
            ...
            <div class="card action-stats-card h-100">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('stock-movements.create')); ?>" class="btn btn-light btn-sm">
                            <i class="fas fa-plus me-2"></i>Novo Movimento
                        </a>
                        <?php if(userCan('view_reports')): ?>
                            <a href="<?php echo e(route('reports.inventory')); ?>" class="btn btn-outline-light btn-sm">
    ...
    <div class="card filter-card">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('stock-movements.index')); ?>" id="filter-form">
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="product" name="product"
                            value="<?php echo e(request('product')); ?>" placeholder="Nome do produto...">
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select" id="movement_type" name="movement_type">
                            ...
                            <option value="in" <?php echo e(request('movement_type') == 'in' ? 'selected' : ''); ?>>Entrada</option>
                            <option value="out" <?php echo e(request('movement_type') == 'out' ? 'selected' : ''); ?>>Saída</option>
                            <option value="adjustment" <?php echo e(request('movement_type') == 'adjustment' ? 'selected' : ''); ?>>Ajuste</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('stock-movements.index')); ?>" class="btn btn-outline-secondary flex-fill">
    ...
    <div class="table-container">
        <div class="table-header">
            <h6 class="mb-0">
                ...
                <span class="badge bg-primary ms-2"><?php echo e($movements->total()); ?></span>
            </h6>
            <div class="d-flex gap-2">
                <?php if(userCan('export_stock')): ?>
                    <button class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-download me-1"></i>Exportar
                    </button>
                <?php endif; ?>
                <a href="<?php echo e(route('stock-movements.create')); ?>" class="btn btn-primary btn-sm">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="movement-row movement-<?php echo e($movement->movement_type); ?>"
                            data-movement-id="<?php echo e($movement->id); ?>">
                            <td>
                                <div class="fw-semibold"><?php echo e($movement->movement_date->format('d/m/Y')); ?></div>
                                <small class="text-muted">
                                    <?php echo e($movement->movement_date->diffForHumans()); ?>

                                </small>
                            </td>

                            <td>
                                <span class="fw-semibold"><?php echo e($movement->created_at->format('H:i')); ?></span>
                            </td>

                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="me-2">
                                        <?php if($movement->product && $movement->product->type === 'service'): ?>
                                    ...
                                    <div>
                                        <?php if($movement->product_id && $movement->product): ?>
                                            <div class="fw-semibold"><?php echo e($movement->product->name); ?></div>
                                            <small class="text-muted">
                                                <?php if($movement->product->type === 'service'): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <small class="text-muted">
                                                <i class="fas fa-exclamation-triangle me-1"></i>ID: <?php echo e($movement->product_id); ?>
                            ...
                            <td>
                                <?php switch($movement->movement_type):
                                    case ('in'): ?>
                            ...
                            <td class="text-end">
                                <span class="fw-bold fs-6 
                                    <?php if($movement->movement_type === 'in'): ?> text-success
                                    <?php elseif($movement->movement_type === 'out'): ?> text-danger
                                    <?php else: ?> text-warning <?php endif; ?>">
                                    <?php if($movement->movement_type === 'out'): ?>-<?php endif; ?><?php echo e(number_format($movement->quantity)); ?>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <small class="text-muted"><?php echo e($movement->user->name ?? 'Sistema'); ?></small>
                                </div>
                            </td>

                            <td>
                                <?php if($movement->reason): ?>
                                    <span class="text-muted" title="<?php echo e($movement->reason); ?>">
                                        <?php echo e(Str::limit($movement->reason, 30)); ?>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('stock-movements.show', $movement)); ?>" 
                                    ...
                                    <?php if(userCan('edit_stock_movements')): ?>
                                    ...
                                    <?php if(userCan('delete_stock_movements')): ?>
                                        <button type="button"
                                                class="btn btn-outline-danger btn-sm"
                                                onclick="confirmDelete(<?php echo e($movement->id); ?>, '<?php echo e($movement->product->name ?? 'Movimento'); ?>')"
                                                title="Excluir"
                                                data-bs-toggle="tooltip">
                            ...
                            <td colspan="8">
                                <div class="empty-state">
                                    ...
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="<?php echo e(route('stock-movements.create')); ?>" class="btn btn-primary">
                                            <i class="fas fa-plus me-2"></i>Registrar Primeiro Movimento
                                        </a>
                                        <a href="<?php echo e(route('stock-movements.index')); ?>" class="btn btn-outline-primary">
            ...
            <div class="card-body border-top bg-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-muted small">
                        Mostrando <?php echo e($movements->firstItem()); ?> a <?php echo e($movements->lastItem()); ?> de <?php echo e($movements->total()); ?> movimentos
                    </div>
                    <div>
                        <?php echo e($movements->appends(request()->query())->links('pagination::bootstrap-5')); ?>
