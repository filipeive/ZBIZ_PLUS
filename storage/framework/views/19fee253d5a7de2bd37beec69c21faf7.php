<?php $__env->startSection('title', "Editar Venda #{$sale->id}"); ?>
<?php $__env->startSection('page-title', "Editar Venda #{$sale->id}"); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('sales.index')); ?>">Vendas</a>
    </li>
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('sales.show', $sale)); ?>">Venda #<?php echo e($sale->id); ?></a>
    </li>
...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('sales.update', $sale)); ?>" method="POST" id="edit-sale-form">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('customer_name', $sale->customer_name)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('customer_phone', $sale->customer_phone)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="cash"
                                        <?php echo e(old('payment_method', $sale->payment_method) == 'cash' ? 'selected' : ''); ?>>
                                        Dinheiro</option>
                                    <option value="card"
                                        <?php echo e(old('payment_method', $sale->payment_method) == 'card' ? 'selected' : ''); ?>>
                                        Cartão</option>
                                    <option value="transfer"
                                        <?php echo e(old('payment_method', $sale->payment_method) == 'transfer' ? 'selected' : ''); ?>>
                                        Transferência</option>
                                    <option value="credit"
                                        <?php echo e(old('payment_method', $sale->payment_method) == 'credit' ? 'selected' : ''); ?>>
                                        Crédito</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control bg-light"
                                    value="<?php echo e($sale->sale_date->format('Y-m-d\TH:i')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" name="notes" id="notes" rows="3"
                                    placeholder="Observações adicionais sobre a venda..."><?php echo e(old('notes', $sale->notes)); ?></textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control"
                                    ...
                                    value="<?php echo e(old('general_discount_value', $sale->discount_percentage > 0 && $sale->discount_type === 'percentage' ? $sale->discount_percentage : ($sale->discount_amount > 0 && $sale->discount_type === 'fixed' ? $sale->discount_amount : ''))); ?>">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="general_discount_type" name="general_discount_type">
                                    ...
                                    <option value="fixed"
                                        <?php echo e(old('general_discount_type', $sale->discount_type) === 'fixed' ? 'selected' : ''); ?>>
                                        Valor Fixo (MZN)</option>
                                    <option value="percentage"
                                        <?php echo e(old('general_discount_type', $sale->discount_type) === 'percentage' ? 'selected' : ''); ?>>
                                        Percentual (%)</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="general_discount_reason"
                                    ...
                                    value="<?php echo e(old('general_discount_reason', $sale->discount_reason)); ?>">
                            </div>
                        </div>
                            ...
                            <table class="table table-hover mb-0" id="items-table">
                                ...
                                <tbody id="items-tbody">
                                    <?php $__currentLoopData = $sale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr class="item-row <?php echo e($hasDiscount ? 'table-warning' : ''); ?>"
                                            data-index="<?php echo e($index); ?>">
                                            <td>
                                                <select class="form-select item-product"
                                                    name="items[<?php echo e($index); ?>][product_id]" required>
                                            ...
                                            <td>
                                                <input type="number" min="1"
                                                    ...
                                                    value="<?php echo e($item->quantity); ?>" required>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <input type="hidden" class="original-unit-price"
                                                        name="items[<?php echo e($index); ?>][original_unit_price]"
                                                        value="<?php echo e($originalPrice); ?>">
                                                </div>
                                            </td>
                                            <td>
                                                <input type="number" step="0.01" min="0"
                                                    ...
                                                    value="<?php echo e($item->unit_price); ?>" required>
                                            </td>
                                            <td class="text-center">
                                                <div class="discount-display">
                                                    <?php if($hasDiscount): ?>
                                                        <span class="text-warning fw-bold">
                                                            -<?php echo e(number_format($item->getSavings(), 2, ',', '.')); ?>

                                                        </span>
                                                        <small class="d-block text-muted">
                                                            (<?php echo e(number_format($item->discount_percentage ?? 0, 1)); ?>%)
                                                        </small>
                                                    <?php else: ?>
                                                        <span class="text-muted">-</span>
                                                    <?php endif; ?>
                                                </div>
                                                <input type="hidden" name="items[<?php echo e($index); ?>][discount_reason]"
                                                    value="<?php echo e($item->discount_reason); ?>" class="discount-reason">
                                            </td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button" class="btn btn-outline-warning"
                                                        onclick="editItemDiscount(<?php echo e($index); ?>)"
                                                        title="Editar Desconto">
                                                        <i class="fas fa-percentage"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-outline-danger"
                                                        onclick="removeItem(<?php echo e($index); ?>)" title="Remover Item">
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary" id="display-subtotal">
                                            <?php echo e(number_format($sale->subtotal, 2, ',', '.')); ?> MT
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr id="discount-row"
                                        style="<?php echo e($sale->discount_amount > 0 ? '' : 'display: none;'); ?>">
                                        ...
                                        <td class="text-end fw-bold text-warning" id="display-discount">
                                            -<?php echo e(number_format($sale->discount_amount, 2, ',', '.')); ?> MT
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group" role="group">
                                <a href="<?php echo e(route('sales.show', $sale)); ?>" class="btn btn-outline-secondary btn-lg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="small text-muted">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <span id="preview-item-count"><?php echo e($sale->items->count()); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                                <span>Itens com Desconto:</span>
                                <span
                                    id="preview-discounted-items"><?php echo e($sale->items->where('discount_amount', '>', 0)->count()); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="small">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-bold">#<?php echo e($sale->id); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Criada em:</span>
                                <span><?php echo e($sale->created_at->format('d/m/Y H:i')); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Vendedor Original:</span>
                                <span class="fw-bold"><?php echo e($sale->user->name ?? 'Sistema'); ?></span>
                            </div>
                            <?php if($sale->updated_at != $sale->created_at): ?>
                                <div class="d-flex justify-content-between mb-2">
                                    <span>Última Edição:</span>
                                    <span><?php echo e($sale->updated_at->format('d/m/Y H:i')); ?></span>
                                </div>
                            <?php endif; ?>
                            <div class="d-flex justify-content-between">
                                <span>Editado por:</span>
                                <span class="fw-bold text-primary"><?php echo e(Auth::user()->name); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <select class="form-select" id="new-item-product" required>
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($product->id); ?>" data-price="<?php echo e($product->selling_price); ?>"
                                    data-stock="<?php echo e($product->stock_quantity); ?>" data-type="<?php echo e($product->type); ?>"
                ...
                <select class="form-select item-product" name="items[${itemIndex}][product_id]" required>
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($product->id); ?>" 
                                ...
                                data-stock="<?php echo e($product->stock_quantity); ?>"
                                data-type="<?php echo e($product->type); ?>"
                                ${productId == '<?php echo e($product->id); ?>' ? 'selected' : ''}>
                            <?php echo e($product->name); ?> 
                            <?php if($product->type === 'product'): ?>
                                (Stock: <?php echo e($product->stock_quantity); ?>)
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fdev-ms/Filipe/ZBIZ_PLUS/resources/views/sales/edit.blade.php ENDPATH**/ ?>