...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Left Column: Tenant Identity & Sector -->
            <div class="space-y-6">
                ...
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl space-y-4">
                    <div class="flex items-center space-x-3 border-b border-slate-800 pb-4">
                        <div class="w-10 h-10 rounded-2xl bg-slate-800 border border-slate-700 flex items-center justify-center text-lg {{ $theme['text_accent'] }}">
                    ...
                    <div>
                        ...
                        <select name="business_type" class="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white focus:ring-1 focus:ring-emerald-500 outline-none">
                            <option value="reprography" {{ ($tenant?->business_type ?? $settings['business_type'] ?? '') === 'reprography' ? 'selected' : '' }}>Gráfica & Reprografia</option>
                        ...
                        <p class="text-[10px] text-slate-500 mt-1">Ajusta automaticamente os ícones, paleta e regras de stock do sistema.</p>
                    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Operational & POS Parameters -->
                <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl backdrop-blur-xl space-y-5">
                    <h3 class="text-sm font-black text-white font-heading flex items-center gap-2 border-b border-slate-800 pb-3">
                        <i class="fa-solid fa-receipt text-amber-400"></i> Parâmetros do POS & Talão Térmico
                    </h3>
