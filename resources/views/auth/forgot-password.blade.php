...
<form method="POST" action="{{ route('password.email') }}" class="space-y-5">
    ...
    <div class="text-center mb-6">
        ...
        <p class="mt-2 text-xs text-slate-400">Informe o seu e-mail ou número de telemóvel para receber o código de recuperação por SMS ou link por e-mail.</p>
    </div>

    <div>
        <label for="email" class="mb-1.5 block text-xs font-bold text-slate-300">E-mail ou Telemóvel</label>
        <div class="relative">
