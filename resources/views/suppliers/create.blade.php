...
@section('page-title', 'Registar Novo Fornecedor')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between bg-slate-900/80 border border-slate-800 rounded-3xl p-5 shadow-xl backdrop-blur-xl">
        ...
        <span class="text-xs text-slate-400 font-medium">Campos com <span class="text-rose-400">*</span> são obrigatórios</span>
    </div>
        ...
        <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="Ex: Distribuidora Farmacêutica Nacional, Lda"
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" value="{{ old('contact_person') }}" placeholder="Ex: Dra. Ana Paula ou Sr. Carlos"
                           class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" placeholder="Ex: +258 84 999 8888"
                           class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="pedidos@fornecedor.co.mz"
                           class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nuit" value="{{ old('nuit') }}" placeholder="Ex: 400987654" maxlength="15"
                    ...
                    <span class="text-[11px] text-slate-500 mt-1 block">Importante para dedução legal de IVA em compras e despesas</span>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="address" value="{{ old('address') }}" placeholder="Ex: Zona Industrial da Machava, Matola"
                           class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium">
                </div>
                ...
                <div>
                    ...
                    <textarea name="bank_details" rows="2" placeholder="Ex: Millennium BIM - Conta: 123456789 | NIB: 000100000012345678901"
                              class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium font-mono">{{ old('bank_details') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="payment_terms" value="{{ old('payment_terms') }}" placeholder="Ex: Pronto Pagamento, 15 Dias, 30 Dias após entrega"
                           class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-2xl text-sm text-white placeholder-slate-600 focus:ring-2 {{ $theme['ring'] }} outline-none font-medium">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" rows="2" placeholder="Informações de produtos fornecidos, prazos de entrega, descontos acordados..."
            ...
            <div class="pt-6 border-t border-slate-800 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2.5 {{ $theme['btn'] }} text-xs font-bold rounded-2xl shadow-lg transition flex items-center gap-2">
                    <i class="fa-solid fa-floppy-disk"></i> Guardar Fornecedor
                </button>
            </div>
        </form>
    </div>
